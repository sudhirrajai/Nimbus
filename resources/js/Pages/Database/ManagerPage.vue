<template>
  <MainLayout>
    ...
    <div class="container-fluid py-3 min-vh-100 d-flex flex-column">
      ...
      <!-- Main Workspace Card -->
      <div class="card flex-grow-1 shadow-xl border-radius-xl overflow-hidden d-flex flex-column" style="min-height: 600px;">
        
        <!-- Tab 1: Browse Data & Schema -->
        <div v-if="activeTab === 'browse'" class="d-flex flex-grow-1 overflow-hidden">
          ...
          <div class="db-main-content flex-grow-1 overflow-y-auto p-4 bg-white d-flex flex-column">
            <template v-if="selectedTable">
              ...
              <div v-if="subView === 'data'" class="flex-grow-1 d-flex flex-column">
                ...
                <!-- Data Table -->
                <div class="table-responsive flex-grow-1 border border-radius-lg overflow-y-auto position-relative" style="max-height: 520px; z-index: 1;">
                ...
                <!-- Pagination Bar -->
                <div v-if="totalPages > 1" class="d-flex justify-content-between align-items-center pt-3 border-top mt-auto">
