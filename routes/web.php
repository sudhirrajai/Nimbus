...
Route::middleware(['auth', \App\Http\Middleware\EnsureSetupComplete::class, \App\Http\Middleware\LogActivity::class])->group(function () {
    ...
    Route::middleware(['permission:wordpress'])->prefix('wordpress')->name('wordpress.')->group(function () {
        ...
        Route::post('/{id}/reset', [\App\Http\Controllers\WordPressController::class, 'reset'])->name('reset');
        Route::post('/{id}/reinstall', [\App\Http\Controllers\WordPressController::class, 'reinstall'])->name('reinstall');
    ...
    // Backups management routes — accessible to root, admin, or users with 'backups' permission
